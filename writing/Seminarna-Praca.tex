...
\begin{titlepage}
	...
	\textbf{Akademický rok:}\quad 2020 / 2021 \\
...
\begin{lstlisting}[caption=Skrátené záznamy z logov počas Slowloris pre HAProxy a NGINX v HTTP móde]
web/<NOSRV> -1/-1/-1/-1/64642 400 187 CR-- 2000/2000/0/0/0 "<BADREQ>"
192.168.0.5  "GET / HTTP/1.1" 408 - - - - -
\end{lstlisting}
...
% Z logov sme vyčítanie plánovacie sekvencie - permutácie serverov
